...
<meta name="theme-color" content="#ffffff">
    ...
    <body style="background-color:#f0f1f2">
     <div class="wrap">
                    ...
                    <div class="col-md-12">
                        ...
                        <nav id="primary-nav" class="dropdown cf">
                            <ul class="dropdown menu">
                                <li class='active'><a href="Demosite.htm">Home</a></li>
                                ...
                                <li>
                                   ...
                                   <li><a class="nav-link" href="index.jsp">Login</a></li>
        ...
        <div class="container p-5" style="padding:500px;height:500px">
             <div class="row mt-5">
                          ...
                          <%
                               ...
                               <%
                                ...
                                %>
                                    ...
                                    %>
                             <h4 class="text-center nam"> Login</h4>
                           
                               
   <form action="LoginServlet" method="post" onsubmit="return myfun()">
  <div class="form-group">
    <label for="ema">Email address</label>
    <input type="email"  name="email" class="form-control" id="ema" required="required" value="" aria-describedby="emailHelp">
...
<div class="text-center">
           <button type="submit" class="btn btn-primary" style="border-radius: 20px;width:300px">Login</button><br>
    ...
    <script>
        function myfun(){
             ...
             var c=document.getElementById("ema").value;
              var d=document.getElementById("area").value;
              if(c==''){
                document.getElementById('em').innerHTML="Please Fill Message";
                return false;
            }
